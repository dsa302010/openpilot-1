...
class LongitudinalPlanner:
  ...
  def update(self, sm, dp_flags = 0):
    ...
    if dp_flags & DPFlags.DTSC:
      ...
      # Get modified acceleration constraints based on curvature AND steering angle
